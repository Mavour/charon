...
function defaultStrategy() {
  return {
    ...
    min_fee_claim_sol: 1.0, min_gmgn_total_fee_sol: 5, min_holders: 0,
    max_top20_holder_percent: 70, min_saved_wallet_holders: 1, max_ath_distance_pct: 0,
    min_graduated_volume_usd: 0, trending_min_volume_usd: 1000, trending_min_swaps: 10,
    ...
    max_hold_ms: 0, use_llm: true, llm_min_confidence: 55,
  };
}
